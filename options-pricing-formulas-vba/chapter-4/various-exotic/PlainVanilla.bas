...
Public Function CGBlackScholes(OutPutFlag As String, Optional CallPutFlag As String, Optional S As Double, Optional X _
                ...
                ElseIf OutPutFlag = "dv" Then 'DDeltaDvol
                ...
                CGBlackScholes = GSaddleGamma(X, T, r, b, v)
                 ...
                 ElseIf OutPutFlag = "gs" Then 'DgammaDspot/speed
                ...
                ElseIf OutPutFlag = "nt" Then 'Numerical Theta
                    CGBlackScholes = GNumericTheta(CallPutFlag, S, X, T, r, b, v, ThetaDays)
                ...
                ElseIf OutPutFlag = "bp" Then 'Brak even probability
                 ...
                 ElseIf OutPutFlag = "sd" Then 'StrikeDelta
                    CGBlackScholes = GStrikeDelta(CallPutFlag, S, X, T, r, b, v)
                ElseIf OutPutFlag = "RND" Then 'Risk Neutral Density
