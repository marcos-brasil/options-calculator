...
Public Function EJumpDiffusionBates(OutPutFlag As String, CallPutFlag As String, S As Double, x As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                EJumpDiffusionBates = JumpDiffusionBates(CallPutFlag, S, x, 1E-05, r, b, v, lambda, avgk, delta) - JumpDiffusionBates(CallPutFlag, S, x, T, r, b, v, lambda, avgk, delta)
        Else
...
Public Function EJumpDiffusionMerton(OutPutFlag As String, CallPutFlag As String, S As Double, x As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                EJumpDiffusionMerton = JumpDiffusionMerton(CallPutFlag, S, x, 1E-05, r, v, lambda, gamma) - JumpDiffusionMerton(CallPutFlag, S, x, T, r, v, lambda, gamma)
        Else
