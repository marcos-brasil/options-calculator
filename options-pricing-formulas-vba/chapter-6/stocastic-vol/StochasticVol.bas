...
Public Function EHullWhite87SV(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                EHullWhite87SV = HullWhite87SV(CallPutFlag, S, X, 1E-05, r, b, v, Vvol) - HullWhite87SV(CallPutFlag, S, X, T, r, b, v, Vvol)
        Else
...
Public Function EHullWhite88SV(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                EHullWhite88SV = HullWhite88SV(CallPutFlag, S, X, 1E-05, r, b, sig0, sigLR, HL, Vvol, rho) - HullWhite88SV(CallPutFlag, S, X, T, r, b, sig0, sigLR, HL, Vvol, rho)
        Else
