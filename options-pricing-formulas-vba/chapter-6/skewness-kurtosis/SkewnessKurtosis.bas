...
Public Function ESkewKurtCorradoSuModified(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                ESkewKurtCorradoSuModified = SkewKurtCorradoSuModified(CallPutFlag, S, X, 1E-05, r, b, v, Skew, Kurt) - SkewKurtCorradoSuModified(CallPutFlag, S, X, T, r, b, v, Skew, Kurt)
        Else
...
Public Function ESkewKurtCorradoSu(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                ESkewKurtCorradoSu = SkewKurtCorradoSu(CallPutFlag, S, X, 1E-05, r, b, v, Skew, Kurt) - SkewKurtCorradoSu(CallPutFlag, S, X, T, r, b, v, Skew, Kurt)
        Else
...
Public Function EJarrowRuddSkewKurt(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                EJarrowRuddSkewKurt = JarrowRuddSkewKurt(CallPutFlag, S, X, 1E-05, r, b, v, Skew, Kurt) - JarrowRuddSkewKurt(CallPutFlag, S, X, T, r, b, v, Skew, Kurt)
        Else
