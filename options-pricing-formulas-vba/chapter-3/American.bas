...
Public Function EBSAmericanApprox2002(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                EBSAmericanApprox2002 = BSAmericanApprox2002(CallPutFlag, S, X, 1E-05, r, b, v) - BSAmericanApprox2002(CallPutFlag, S, X, T, r, b, v)
        Else
...
Public Function EBSAmericanApprox(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                EBSAmericanApprox = BSAmericanApprox(CallPutFlag, S, X, 1E-05, r, b, v) - BSAmericanApprox(CallPutFlag, S, X, T, r, b, v)
        Else
...
Public Function EBAWAmericanApprox(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, _
    ...
    ElseIf OutPutFlag = "t" Then 'Theta
         If T <= 1 / 365 Then
                EBAWAmericanApprox = BAWAmericanApprox(CallPutFlag, S, X, 1E-05, r, b, v) - BAWAmericanApprox(CallPutFlag, S, X, T, r, b, v)
        Else
